...
trait CalculateBaseInterface {
  ...
  def sectionDistribution(map: Map[Array[String], Double], x: Int): mutable.Map[Array[String], Double]
  ...
  def dynamicOdDistributionResult(targetOd: String,allKsp:mutable.Map[String, util.List[DirectedPath]],odMap:mutable.Map[String,Integer]): mutable.Map[Array[String], Double]
  //通号院对接
  ...
  def tongHaoDynamicOdDistributionResult(targetOd: String,allKsp:mutable.Map[String, util.List[DirectedPath]],odMap:mutable.Map[String,String]): mutable.Map[Array[String],Double]
