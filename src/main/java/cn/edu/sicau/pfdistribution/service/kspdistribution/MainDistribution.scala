...
@Service
case class MainDistribution @Autowired() (calBase:CalculateBaseInterface,getOdList: GetOdList,getParameter: GetParameter,val kServiceImpl:KServiceImpl)extends Serializable { //,val getOdList: GetOdList
